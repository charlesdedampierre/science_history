...
if __name__ == "__main__":
    ...
    list_individuals = list(df_ind_regions["wikidata_id"])
    ...
    print(n_sample_individual)
    batch_number = 20

    for n_neighbours in tqdm(np.arange(1, 10)):
    ...
    df_final.to_sql("optimization_europe", conn, if_exists="replace", index=False)
    print(df_final)
