...
if __name__ == "__main__":
    df = pd.read_csv("data/random_2.csv")
    ...
    df_edge.to_csv("matrix/random_2.csv")
    ...
    df_partition, g = sygma_graph_leiden(
        ...
        edge_bins=10,
        node_bins=10,
        filepath=GRAPH_RESULTS + "/random_2.html",
    )

    df_partition = df_partition.sort_values("community")
    df_partition.to_sql("partition_random_2", conn, if_exists="replace", index=False)
