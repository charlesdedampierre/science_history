...
if __name__ == "__main__":
    ...
    df_temporal = df_temporal[df_temporal["birthyear"] >= 1800]
    ...
    df_partition, g = sygma_graph(
        ...
        filepath=GRAPH_RESULTS + "/after_1800_europe.html",
    )

    df_partition.to_sql(
        "partition_after_1800_europe", conn, if_exists="replace", index=False
    )
