...
from region_filters import columns_eu, columns_non_eu, columns_non_eu_unique
...
if __name__ == "__main__":
    ...
    final_regions = ["re_europe"] + columns_non_eu_unique

    """
    sample_size = 100
    df_fin = df_regions.groupby("region_code").sample(
    ...
    for region in final_regions:
        ...
        if len(df_sample) > individual_sample:
            res = df_sample.sample(individual_sample, random_state=42)
        else:
            res = df_sample.copy()
    ...
    final_individuals = individuals_filters
